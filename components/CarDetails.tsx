                   ...
                   <div className='mt-3 flex flex-wrap gap-4'>
                        {
                          Object.entries(car).map(([key,value],ind) =>(
                             <div className='flex justify-between gap-5 w-full text-right' key={ind}> 
                               <h4 className='text-gray capitalize' key={key} >{key.split("_").join(" ")}</h4>
                               <p className='text-black-100 font-semibold' key={key}>{value}</p>
                             </div>
                          ))
                        }
                   </div>
